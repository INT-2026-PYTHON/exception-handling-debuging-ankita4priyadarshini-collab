...
def process_strict(records):
    try:
        ...
        if len(error_log) > 0:
            raise RuntimeError(str(len(error_log)) + " record(s) failed to process")
        return clean_records
    except RuntimeError:
        raise
            
records = [{"name": "Alice", "age": "25", "score": "88.5"}, {"name": "Bob", "age": "abc", "score": "70"}, {"name": "Carol", "age": "30"},"not a dict", {"name": "Dan", "age": "40", "score": "55.5"}]
clean_records, error_log = process_records(records)
print("Clean Records:")
print(clean_records)
print("\nError Log:")
